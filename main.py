...
def get_args_parser():
    ...
    parser.add_argument('--epochs', default=1287, type=int,
                        help='default number of epochs (from ImageNet1k)')
    ...
    parser.add_argument('--warmup_steps', type=int, default=6240, metavar='N',
                        help='num of steps to warmup LR (from ImageNet1k)')
    ...
    parser.add_argument('--data_set', default='bias', choices=['CIFAR', 'IMNET', 'image_folder', 'bias'],
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            lr_schedule_values=lr_schedule_values, num_training_steps_per_epoch=num_training_steps_per_epoch,
            update_freq=args.update_freq, use_amp=args.use_amp
        )
