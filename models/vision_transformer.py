...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 drop_path_rate=0., hybrid_backbone=None, norm_layer=nn.LayerNorm, class_token: bool = True, pretrained_cfg=None):
        super().__init__()
...
@register_model
def vit_tiny_no_cls(pretrained=False, **kwargs):
    """ ViT-Tiny (Vit-Ti/16)
    """
    model = VisionTransformer(
        patch_size=16, embed_dim=192, depth=12, num_heads=3, mlp_ratio=4, class_token= False,qkv_bias=True,
        norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model
